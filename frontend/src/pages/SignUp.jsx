...
const styles = `
  ...
  .auth-glow-2 {
    ...
    background: radial-gradient(circle, rgba(0,184,255,0.07) 0%, transparent 65%);
  ...
  .auth-btn {
    width: 100%;
    padding: 13px;
    background: linear-gradient(135deg, rgba(167,139,250,0.15), rgba(0,184,255,0.08));
  ...
  .auth-btn:hover:not(:disabled) {
    background: linear-gradient(135deg, rgba(167,139,250,0.22), rgba(0,184,255,0.14));
...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${url}/auth/signup`, { name, userName, email, password }, { withCredentials: true });
    ...
    <>
      ...
      <div className="auth-root">
        ...
        <div className="auth-card">
          ...
          <div className="auth-subtitle">// create new identity</div>
